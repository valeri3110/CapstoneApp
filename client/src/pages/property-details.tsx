			...
			>
						...
						>
							...
							<Box>
								...
								<Stack direction='row' alignItems='flex-end' gap={1}>
									<Typography fontSize={25} fontWeight={700} color='#cc9933'>
				...
				>
					...
					>
						...
						>
							<CustomButton
								title={!isCurrentUser ? "Написати" : "Редагувати"}
							...
							/>
							<CustomButton
								title={!isCurrentUser ? "Тел" : "Видалити"}
								backgroundColor={!isCurrentUser ? "#d42e2e" : "#d42e2e"}
								color='#FCFCFC'
								fullWidth
